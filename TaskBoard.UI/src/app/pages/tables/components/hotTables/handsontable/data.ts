export function genData(rows: number = 10): Array<any> {
    let products: Array<any> = [
        ...
        firstNames = [
            "Ted", "John", "Macy", "Rob", "Gwen", "Fiona", "Mario",
            "Ben", "Kate", "Kevin", "Thomas", "Frank"
        ],
        lastNames = [
            "Tired", "Johnson", "Moore", "Rocket", "Goodman", "Farewell",
            "Manson", "Bentley", "Kowalski", "Schmidt", "Tucker", "Fancy"
        ],
        address = [
            "Turkey", "Japan", "Michigan", "Russia", "Greece", "France", "USA",
            "Germany", "Sweden", "Denmark", "Poland", "Belgium"
        ];

    let items: Array<any> = [];
    let product: any;
    let newProduct: { description;options: any[] };
